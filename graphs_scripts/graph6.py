...
for s in sizes:
	...
	for c in [ "Heap" , "SkipList" , r'$q$-MAX,$\gamma=$0.05' , r'SQUID,$\gamma=$0.05' ,  r'$q$-MAX,$\gamma=$0.1' , r'SQUID,$\gamma=$0.1', r'$q$-MAX,$\gamma=$0.25'  , r'SQUID,$\gamma=$0.25']:
	    ...
	    yerr = []
	    for t in traces:
	        if t=="caida16" or t=="caida18": y.append(j[c][t])
	        elif t=="univ1" and c[0]=='S' : y.append(j[c][t]+1)
	        else: y.append(((j[c][t] + 3)*1.2))
        
	        
	        yerr.append(jstd[c][t])
        #y = [x for x in y]
        
        #if(c==r'SQUID,$\gamma=$0.05' or c==r'SQUID,$\gamma=$0.1' or c==r'SQUID,$\gamma=$0.25'):
            #y[0] -=5
